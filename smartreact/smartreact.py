...
class SmartReact(commands.Cog):
    ...
    async def create_smart_reaction(self, guild, word, emoji, message):
        ...
        except (discord.errors.HTTPException, discord.errors.ClientException, TypeError):
    ...
    async def on_message(self, message):
        ...
        for emoji in reacts:
            if set(w.lower() for w in reacts[emoji]).intersection(words):
                ...
                try:
                    await message.add_reaction(emoji)
                except (discord.errors.Forbidden, discord.errors.ClientException, discord.errors.NotFound):
                    pass
